...
const CrearCuenta = () => {
    ...
    const { cuentaModal, handleCuentas, cuenta, submitCuenta, setCuentaModal, mostrarAlerta, alerta } = UseView();
    ...
    const handleSubmit = async e => {
        ...
        await submitCuenta({ id, nombre, siglas });
        setNombre('');
        setSiglas('');
    ...
    return (
        <Transition.Root show={cuentaModal} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleCuentas}>
